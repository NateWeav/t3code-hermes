...
const NAME = "org.gnome.Shell.Extensions.T3HermesSnapShot";
const PATH = "/org/gnome/Shell/Extensions/T3HermesSnapShot";
...
export default class T3HermesSnapShotExtension extends Extension {
  enable() {
