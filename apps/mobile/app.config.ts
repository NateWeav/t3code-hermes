...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveBackgroundColor: "#0D9488",
...
const VARIANT_CONFIG = {
  development: {
    appName: "T3 Hermes Dev",
    scheme: "t3-hermes-dev",
    iosBundleIdentifier: "com.nateweav.t3hermes.dev",
    androidPackage: "com.nateweav.t3hermes.dev",
    relyingParty: "clerk.t3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "T3 Hermes Preview",
    scheme: "t3-hermes-preview",
    iosBundleIdentifier: "com.nateweav.t3hermes.preview",
    androidPackage: "com.nateweav.t3hermes.preview",
    relyingParty: "clerk.t3.codes",
  ...
  production: {
    appName: "T3 Hermes",
    scheme: "t3-hermes",
    iosBundleIdentifier: "com.nateweav.t3hermes",
    androidPackage: "com.nateweav.t3hermes",
    relyingParty: "clerk.t3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active T3 Hermes agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    // Signing belongs to the Hermes distributor, including extension targets.
    appleTeamId: repoEnv.T3CODE_APPLE_TEAM_ID?.trim() || undefined,
    associatedDomains: [
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow T3 Hermes to connect to T3 Hermes servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow T3 Hermes to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow T3 Hermes to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow T3 Hermes to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    ...(repoEnv.T3HERMES_EAS_PROJECT_ID?.trim()
      ? { eas: { projectId: repoEnv.T3HERMES_EAS_PROJECT_ID.trim() } }
      : {}),
  },
  owner: repoEnv.T3HERMES_EXPO_OWNER?.trim() || undefined,
};
