/**
 * All text `t3-hermes triage` hands to the coding agent. Kept as bare template strings
...
- How is T3 Code running on this machine: \`npx t3-hermes serve\` in a terminal, the
...
having a problem with their install and started this session with \`t3-hermes triage\`.
...
Generated by \`t3-hermes triage\` at ${input.generatedAt}.
