 ...
 * executable in the sibling `t3-hermes-<platform>-<arch>` package.
 *
...
const executable = join(dirname(require.resolve("t3-hermes-" + process.platform + "-" + process.arch + "/package.json")), executableName);
