...
export const NPM_PLATFORM_PACKAGE_SCOPE = ".";
export const NPM_LAUNCHER_PACKAGE_NAME = "t3-hermes";
...
export function npmPlatformPackageReadme(platformKey: CliArchivePlatformKey): string {
  return [
    ...
    "```",
    "",
    "Source and documentation: https://github.com/NateWeav/t3code-hermes",
    "",
  ].join("\n");
}
...
try {
  ...
  process.stderr.write(
    [
      ...
      "The desktop app and release archives are at https://github.com/NateWeav/t3code-hermes/releases",
      "",
    ].join("\\n"),
  );
  process.exit(1);
